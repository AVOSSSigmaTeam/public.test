...
export function hallOfFame(page) {
...
`;
    ...
    const startDrag = (x, y) => {
        ...
        page.body.classList.add("dragging");
        previousMouse.x = x;
        previousMouse.y = y;
    ...
    const isUIElement = (target) => {
        const navbar = page.querySelector('.master-navigation');
        const statsBar = page.querySelector('.gallery-stats-bar');
    ...
    const onPointerDown = (e) => {
        ...
        const overlay = page.getElementById("youtube-overlay");
    ...
    const showYouTubeOverlay = (project) => {
        ...
        let overlay = page.getElementById("youtube-overlay");
        if (!overlay) {
    ...
    `;
        ...
        page.getElementById("gallery")?.classList.add("blurred");
    ...
    const hideYouTubeOverlay = () => {
        ...
        if (overlay) {
            ...
            overlay.querySelector("#youtube-iframe").src = "";
            page.getElementById("gallery")?.classList.remove("blurred");
    ...
    const setupEventListeners = () => {
        const gallery = page.getElementById("gallery");

        // Attach mouse events to page for drag continuity
        ...
        page.addEventListener("mouseleave", onPointerUp);
    ...
    page.getElementById('totalViews').textContent = formatTotal(totalMillions);
};
