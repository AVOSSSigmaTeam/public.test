...
const expandingSection = document.querySelector('[data-spotlight-section]');

if (expandingSection && pendingHash) {
  ...
  observer.observe(expandingSection);
}
...
const articleBodyLinkWhitelist = ["7clouds.com"];
...
function initAfterEnterFunctions(next) {
  ...
  if (pageType == 'article') {
    ...
    setArticleBodyLinksToNofollow(nextPage, articleBodyLinkWhitelist);
